...
//  gasolinaOuAlcool
//
//  Created by Lígia Viana Azevedo on 26/02/22.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var restultadoLegenda: UILabel!
        ...
        if let precoAlcool = precoAlcoolCampo.text {
            if let precoGasolina = precoGasolinaCampo.text {
                ...
                if validaCampos{
                    ...
                    restultadoLegenda.text = "Digite os preços para calcular!"
                }
        ...
        if let valorAlcool = Double(precoAlcool){
            if let valorGasolina = Double(precoGasolina){
                ...
                if resultadoPreco >= 0.7 {
                    self.restultadoLegenda.text = "Melhor utilizar Gasolina!"
                }else {
                    self.restultadoLegenda.text = "Melhor utilizar Alcool!"
                }
